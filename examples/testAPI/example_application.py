...
def main():
    ...
    with RestClientPE(base_url=url) as rest_client:
        try:
            ...
            # Si en el futuro necesitas importar dispositivos masivamente, esta es la función,
            # pero requiere un objeto BulkImportRequest con el contenido del archivo y el mapeo.
